...
export default hopeTheme({
    ...
    plugins: {
        ...
        // The following config is for demo ONLY, if you need comment feature, please
        // generate and use your own config, see comment plugin documentation for
        // details. To avoid disturbing the theme developer and consuming his
        // resources, please DO NOT use the following config directly in your
